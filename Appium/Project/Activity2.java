package nativeAppProject;
	...
	public class Activity2 {
		...
		public void todolistTest1() {
			...
			driver.findElement(AppiumBy.xpath("//android.view.View[@content-desc=\"05 March 2026\"]")).click();
			...
			String result1 = driver.findElement(AppiumBy.xpath(
					"//android.widget.TextView[contains(@text,'Deadline: 05.03.2026')]"
					)).getText();
			System.out.println(result1);
			assertEquals(result1,"Deadline: 05.03.2026");
		}
		@AfterClass
