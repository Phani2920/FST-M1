...
public class BrowserActivity2 
{
	...
	public void validTest() {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(AppiumBy.xpath("//android.widget.TextView[@text=\"Login Form\"]"))).click();	 
	...
	public void invalidTest() {
	  ...
	  String messageText = driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"Invalid credentials\"]")).getText();		
		System.out.println(messageText);
