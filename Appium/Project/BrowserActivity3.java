...
public class BrowserActivity3 
{
	...
	public void popupTest() {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(AppiumBy.androidUIAutomator(UiScrollable + ".scrollForward(40)")));
		//driver.findElement(AppiumBy.androidUIAutomator(UiScrollable + ".flingForward(2)"));
	 ...
	 wait.until(ExpectedConditions.elementToBeClickable( AppiumBy.androidUIAutomator("new UiSelector().text(\"Popups\")"))).click();
	  //WebElement allow = new WebDriverWait(driver, Duration.ofSeconds(8)).until(ExpectedConditions.elementToBeClickable(AppiumBy.androidUIAutomator("new UiSelector().text(\"Popups\")")));
	  //allow.click();
